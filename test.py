CHAPTER_VERSE_NUMBER = {1: [(1, 7)], 2: [(1, 286)], 3: [(1, 200)], 4: [(1, 176)], 5: [(1, 120)], 6: [(1, 165)],
...
if __name__ == '__main__':
    ...
    while True:
        try:
            num = next(chapter_num)
            print(num, ": ")
            verse_gen = next_verse(num)
            while True:
                try:
                    verse_num = next(verse_gen)
                    print(f'{verse_num}', end=', ')
